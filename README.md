This plugin is a fork (for PR) of https://github.com/kartenkarsten/leaflet-layer-overpass

To continue the work without disturbing the original plugin, I created a separate fork here:
